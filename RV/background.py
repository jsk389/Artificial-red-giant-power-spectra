...
class Background:
    ...
    def __init__(self, _freq, _nyq, _dnu, _numax, _dt, _kmag, _Teff,
                 mission):
    ...
    def calc_amplitudes(self):
        ...
        elif self.mission == 'SONG':
            # Calculate for intensity and then scale to velocity
            a1 = (3382 * self.numax ** -0.609)
            a2 = 3382 * self.numax ** -0.609
            print("A1, A2: ", a1, a2)
            # Scale to velocity
            a1 = 0.13 * np.sqrt(self.Teff/5777.) * (a1 / 40.0)
            a2 = 0.13 * np.sqrt(self.Teff/5777.) * (a2 / 40.0)
        print("A1, A2: ", a1, a2)
        return a1, a2
    ...
    def shot_noise(self):
        ...
        if self.mission == 'Kepler':
            ...
            print("SHOT NOISE CURRENTLY FIXED TO 0.002 (m/s)^2 per uHz!")
            return 0.00036#0.002
        else:
    ...
    def __call__(self):
        ...
        print(self.numax/(self.f[1]-self.f[0]), len(m))
